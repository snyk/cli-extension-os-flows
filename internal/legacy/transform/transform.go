...
func FindingsToLegacyVulns(
	...
	for _, finding := range findings {
		...
		for _, vuln := range findingVulns {
			vulns = append(vulns, ensurePackageManager(vuln, packageManager))
		}
	}
	return vulns, nil
}

func ensurePackageManager(vuln definitions.Vulnerability, defaultPackageManager string) definitions.Vulnerability {
