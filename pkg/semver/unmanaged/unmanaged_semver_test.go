...
func TestCompare(t *testing.T) {
	...
	tests := []testCase{
		...
		{lhs: "1.0.alpha1.1", rhs: "1.0-a1.1", expected: 0},
		...
		{lhs: "1-0.ga", rhs: "1.0", expected: 0},
		{lhs: "1.0-final", rhs: "1.0", expected: 0},
		{lhs: "1-0-ga", rhs: "1.0", expected: 0},
		{lhs: "1-0-final", rhs: "1-0", expected: 0},
		...
		{lhs: "1.2", rhs: "1.1-5", expected: 1},
		{lhs: "1.0+1", rhs: "1.0", expected: 1},
		{lhs: "1.0+10", rhs: "1.0+2.0", expected: 1},
		{lhs: "1.1", rhs: "1.0+5", expected: 1},
		...
		{lhs: "1.1-1.2", rhs: "1.1-10", expected: -1},
